...
Set_aria2_RPC_dir(){
	...
	[[ -z "${aria2_RPC_dir}" ]] && aria2_RPC_dir="/samba"
	echo
...
Set_aria2_vim_conf(){
	...
	echo -e "${Tip} 手动修改配置文件须知（vim 文本编辑器）：
...
${Green_font_prefix}5.${Font_color_suffix} 如果你想在本地编辑配置文件，那么配置文件位置： ${Green_font_prefix}/etc/aria2/aria2.conf${Font_color_suffix} " && echo
